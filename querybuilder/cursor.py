...
def jsonify_cursor(django_cursor):
    ...
    # One other option might be to check the class of inner_cursor to see if it is the real database cursor.
    # That would require importing more django libraries, and probably having to handle some
    # changes in those libraries over different verisons.
